    ...
    <>
        ...
        <div className="flex justify-between items-center max-w-[720px] mx-auto px-6 w-full h-full">
          ...
          <div className="flex gap-6 items-center">
            <div className="hidden md:flex gap-8">
              ...
              <a className="text-[#8d7dca] font-bold font-label tracking-tighter uppercase text-xs" href="#">Work</a>
              {/* Inactive links — muted-foreground 9.1:1 ✓ */}
              <a className="text-muted-foreground hover:text-[#8d7dca] transition-colors duration-300 font-label tracking-tighter uppercase text-xs" href="#">About</a>
              <a className="text-muted-foreground hover:text-[#8d7dca] transition-colors duration-300 font-label tracking-tighter uppercase text-xs" href="#">Studio</a>
              <a className="text-muted-foreground hover:text-[#8d7dca] transition-colors duration-300 font-label tracking-tighter uppercase text-xs" href="#">Lab</a>
            </div>
            <button className="text-[#8d7dca] font-label tracking-tighter uppercase text-xs scale-95 transition-transform duration-200">Contact</button>
          </div>
        </div>
      </nav>
      ...
      <aside className="fixed right-0 top-0 h-full z-[200] flex flex-col p-8 bg-[#0e0e0e] w-[320px] shadow-[0_20px_40px_rgba(0,0,0,0.4)] translate-x-full lg:translate-x-0 hidden">
        ...
        <div className="flex flex-col gap-1 flex-grow">
          <a className="flex justify-between items-center py-3 px-2 text-muted-foreground hover:bg-[#1a1a1a] hover:text-[#8d7dca] transition-all font-mono text-[10px] tracking-widest uppercase group" href="#">
            <span>Instagram</span>
      ...
      <main className="max-w-[720px] mx-auto px-6 pt-32 pb-24">
        ...
        <section className="mb-48">
          <div className="mb-12 flex items-baseline gap-4">
            ...
            {/* 9.1:1 ✓ */}
            <h2 className="font-headline text-lg uppercase tracking-tight text-muted-foreground">Selected Work</h2>
          </div>
          <div className="flex flex-col gap-0">

            {/* Lumina */}
            <div className="group relative project-reveal">
              <a className="flex items-center justify-between py-10 border-b border-[#262626] group-hover:border-[#8d7dca]/40 transition-colors" href="#">
                {/* 19.4:1 ✓ */}
            ...
            {/* Vertex */}
            <div className="group relative project-reveal">
              <a className="flex items-center justify-between py-10 group-hover:border-[#8d7dca]/40 transition-colors" href="#">
        ...
        <section className="mb-48">
          <div className="mb-12 flex items-baseline gap-4">
            ...
            <h2 className="font-headline text-lg uppercase tracking-tight text-muted-foreground">Introduction</h2>
          </div>
          <div className="max-w-[540px]">
            ...
            <a className="inline-flex items-center gap-3 font-mono text-[10px] uppercase tracking-[0.2em] text-[#8d7dca] group" href="#">
              READ THE ARCHIVE
      ...
      <footer className="max-w-[720px] mx-auto px-6 flex justify-between items-end w-full pb-12 pt-24 border-t border-[#262626]">
        ...
        <div className="flex gap-8">
          {/* 9.1:1 ✓ hover → 19.4:1 */}
          <a className="font-mono text-[0.6875rem] uppercase tracking-[0.05em] text-muted-foreground hover:text-foreground transition-colors underline underline-offset-4 decoration-[#8d7dca]" href="#">Email</a>
          <a className="font-mono text-[0.6875rem] uppercase tracking-[0.05em] text-muted-foreground hover:text-foreground transition-colors" href="#">Archive</a>
          <a className="font-mono text-[0.6875rem] uppercase tracking-[0.05em] text-muted-foreground hover:text-foreground transition-colors" href="#">Source</a>
        </div>
      </footer>
